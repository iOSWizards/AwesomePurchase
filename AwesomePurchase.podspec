...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of AwesomePurchase.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/evandro@itsdayoff.com/AwesomePurchase'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'evandro@itsdayoff.com' => 'evandro@itsdayoff.com' }
  s.source           = { :git => 'https://github.com/evandro@itsdayoff.com/AwesomePurchase.git', :tag => s.version.to_s }
